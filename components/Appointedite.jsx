...
export default function Edieappointment({
  storename,
  Editappointsetter,
  appointment_id,
  appointment_date,
  ...
  function SuccessHandler() {
    ...
    setTimeout(() => Editappointsetter(), 2000)
  }
    ...
    <>
      <div className="transition-all duration-700">
        ...
        >
          {Success ? (
            Sucssmsg(
              ' An appointment has been successfully Updated for ' +
                storename +
                ' store 😎'
            )
          ) : (
            <div className="relative -top-16 m-1 mx-auto block h-auto w-3/4  max-w-2xl  items-center justify-center rounded-md bg-gray-100 p-2 transition-all duration-700">
              <blockquote className="m-1 items-center justify-center p-1 text-center text-lg font-semibold italic text-slate-900">
                <span>You are about to modify your appointment to visit</span>
              ...
              >
                ...
                <div className="flex w-full items-center justify-center">
                  <input
                    defaultValue={appointment_date.slice(0, 16)}
                    min={minDate}
                    onChange={(e) => {
                ...
                {Nodate && 
                Warnmsg('Please select  (Date & Time) first 😅❕')
                }
                {/* body */}
                {/* <!--footer--> */}
